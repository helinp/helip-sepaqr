...
{
    private function createDto(string $structured, string $unstructured): SEPADto
    {
        return new SEPADto(
    ...
    public function testStructuredReferenceOnlyIsValid(): void
    {
    ...
    public function testUnstructuredReferenceOnlyIsValid(): void
    {
        $dto = $this->createDto('', 'Facture avril 2024');
        $this->expectNotToPerformAssertions();
        ReferenceValidator::validate($dto);
    }

    public function testBothReferencesEmptyIsValid(): void
    {
        $dto = $this->createDto('', '');
        $this->expectNotToPerformAssertions();
        ReferenceValidator::validate($dto);
    ...
    {
        $dto = $this->createDto('RF18539007547034', 'Facture avril 2024');
